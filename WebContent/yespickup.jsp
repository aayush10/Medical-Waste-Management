...
<body class = "bg" align= "center" id = "cen">
	<p> Your pickup is on ${pickup}</p>
	<p>Book another pickup</p>
	<form name = "bookPickup" method = "post" action = "booked"><b>
	Appointment date: <input type="date" name = "bookDay"><br>
	Time : <input type = "radio" style = "margin-top:18px"name = "time" value = "Morning"> Morning<br>
			<input type = "radio" name = "time" value = "Evening">Evening<br>
			
	Expected Waste(in kgs) <input style = "margin-top:18px"  type = "number" id = "weight" name = "weight">
	<p id = "pric"></p>
	<button onclick= "return checkPrice()"> Check Price</button>
